...
<!-- table Start -->
			...
			<table class="col-md-12 table table-striped tablesorter">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><span><?php echo ($vo["message"]); ?></span></td>
					<td  width="130px">
						<a  href="<?php echo U('Admin/reportJu');?>?id=<?php echo ($vo["commentid"]); ?>&&status=0" style="color: greenyellow;" >没问题</a>
						<span onclick='del2(this,"<?php echo ($vo["commentid"]); ?>","/project/index.php/Admin/Admin/cdel")'>删除</span></a>
