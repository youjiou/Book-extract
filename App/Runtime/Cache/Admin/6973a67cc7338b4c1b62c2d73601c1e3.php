...
<!-- table Start -->
			<table class="col-md-12 table table-striped tablesorter">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><a onclick="abook(this,'<?php echo ($vo["userid"]); ?>')">《<?php echo ($vo["bookname"]); ?>》...</a></td>
					<td>
						<a href="<?php echo U('Admin/authorInfoUpdate');?>?id=<?php echo ($vo["userid"]); ?>">修改</a>
						<span onclick='del2(this,"<?php echo ($vo["userid"]); ?>","/project/index.php/Admin/Admin/adel")'>删除</span>
