...
<!-- table Start -->
			...
			<table class="col-md-12 table table-striped tablesorter">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><a href="<?php echo U('Admin/bookRead');?>?bid=<?php echo ($vo["bid"]); ?>">《<?php echo ($vo["bookname"]); ?>》</a></td>
					<td><?php echo ($vo["name"]); ?></td>
					<td><?php echo ($vo["publishedtime"]); ?></td>

					<td><span><?php echo ($vo["introduction"]); ?></span></td>
					<td  width="130px">
						<a  href="<?php echo U('Admin/booksDoCheck');?>?id=<?php echo ($vo["bid"]); ?>&&status=1" style="color: greenyellow;" >通过</a>
						<a  href="<?php echo U('Admin/booksDoCheck');?>?id=<?php echo ($vo["bid"]); ?>&&status=2" style="color: red;">不通过</span></a>
