...
<a href="<?php echo U('Admin/Admin/bookInfo');?>">bookInfo-></a>
	<a href="#">bookInfoUpdata</a>
...
<!-- table Start -->
    ...
    <div  class="col-md-6 col-xs-offset-3">
        <form method="post" action="/project/index.php/Admin/Admin/booksInfoSave" class="form-horizontal" role="form" style="width:100%; padding:50px 0px 0px 0px;">
            <input type="text" name="id" id="id" value="<?php echo ($list["0"]["bid"]); ?>" hidden="" /> <!--bid-->

            <div class="col-md-8 col-xs-12 input-field">
                <input type="text" required="" name="bookName" id="bookName" value="<?php echo ($list["0"]["bookname"]); ?>"  class="validate"/><br>
                <label for="bookName">bookName</label>   <!--bookName-->
            </div>

            <div class=" col-md-8 col-xs-12 input-field">
                <input type="text" required="" name="status" id="status" value="<?php echo ($list["0"]["status"]); ?>"  class="validate"/><br>
                <label for="status">状态:</label>
            </div>

            <div class=" col-md-8 col-xs-12 input-field">

              <label for="status">简介:</label>
                <textarea  style="height:100px" id="introduction" name="introduction"><?php echo ($list["0"]["introduction"]); ?></textarea>
            </div>
