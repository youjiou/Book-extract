...
<!-- table Start -->
			...
			<table class="col-md-12 table table-striped tablesorter">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><?php echo (date('Y-m-d',strtotime($vo["publishedtime"]))); ?></td>
					<td><span><?php echo ($vo["introduction"]); ?></span></td>
					<td width="130px">
						<a href="<?php echo U('Admin/bookInfoUpdate');?>?id=<?php echo ($vo["bid"]); ?>">修改</a>
						<span onclick='del2(this,"<?php echo ($vo["bid"]); ?>","/project/index.php/Admin/Admin/bdel")'>删除</span>
